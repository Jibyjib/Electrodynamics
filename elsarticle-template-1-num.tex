...
\begin{equation}
    \nabla \x ( \frac{1}{\mu_0}\b B - \b M) = \b J_f.
\end{equation}
...
\begin{equation}
    \nabla \x \b E = - \frac{\partial \b B}{\partial t},
\end{equation}

in its differential form, and in its integral form

\begin{equation}
    \oint \b E \. d \bell  = - \int \frac{\partial \b B}{\partial t} \. d\b a = -\frac{d \Phi}{dt}.
\end{equation}
...
\begin{equation}
    \b E = - \frac{1}{4 \pi} \frac{\partial}{\partial t} \int \frac{\b B \x \hr}{\r ^2}d\tau.
\end{equation}
...
%%Figure out how to do all of these together
