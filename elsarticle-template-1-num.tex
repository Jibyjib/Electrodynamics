...
and thus we are able to carry out the normal process of figuring out the Poynting and calculating the radiation you would end back up at the Larmor formula if you are travelling at a non-relativistic speed. What if this was at a relativistic speed though?\footnote{I really don't understand why in Griffiths this section becomes before special relativity. I feel like this section should be the last section in the book because we use relativity throughout it as well as go into field equations that he doesn't talk about until later.} The relativistic equation to the Larmor formula is called Li\'enard's generalization and is
...
What are the potentials of a moving point charge? Well the answer are the Li\'enard-Wiechert potentials. They are
...
What then are the fields? The fields, if starting from the Li\'enard-Wiechert potentials are

\begin{equation}
    \b E(\b r,t) \k \frac{q \r}{(\r \. \b u)^3}[(c^2-v^2)\b u + \r \x (\b u \x \b a)],
\end{equation}
